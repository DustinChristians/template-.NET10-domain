# .NET 10 Domain Template
A sample .NET 10 CRUD solution to be used as a template for new projects.
...
- You will need to download and install .NET 10 from Microsoft if you don't already have it.
